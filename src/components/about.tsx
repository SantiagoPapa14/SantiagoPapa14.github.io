          ...
          <div className="md:w-1/2 mt-8 md:mt-0 md:pl-8">
            <div>
              ...
              <div className="w-full max-sm:text-center ">
                <h2 className="relative uppercase mb-5 font-bold text-4xl text-gray-800 after:content-[''] after:absolute after:bottom-[-8px] after:left-1/2 md:after:left-1/14 after:-translate-x-1/2 after:w-16 after:h-1 after:bg-gradient-to-r after:from-blue-500 after:to-indigo-500">
                  Sobre nosotros
                </h2>
              </div>
              ...
              {/* List Section */}
              <div className="flex w-full flex-wrap text-sm justify-center">
                {/* First List */}
                ...
                <div className="w-full sm:w-1/2 md:pl-4">
                  <ul className="list-none pl-0">
                    ...
                    <li className="mb-2">
                      <span className="text-blue-500 mr-2">✓</span>
                      <span className="text-gray-600">
                        Conexiones internacionales para productos premium{" "}
                      </span>
                    </li>
                    <li className="mb-2">
                      <span className="text-blue-500 mr-2">✓</span>
